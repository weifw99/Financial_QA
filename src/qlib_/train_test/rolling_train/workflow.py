...
class RollingDataWorkflow:
    ...
    def _init_qlib(self):
        """initialize qlib"""
        # provider_uri = "/Users/dabai/liepin/study/llm/Financial_QA/data/qlib_data/zh_qlib"  # target_dir
        provider_uri = "/Users/dabai/.qlib/qlib_data/cn_data"  # target_dir
    ...
    def rolling_process(self):
        ...
        for rolling_offset in range(self.rolling_cnt):
            ...
            print(f"===========start_time {datetime(train_start_time[0] + rolling_offset, *train_start_time[1:])} ===========")
            print(f"===========end_time {datetime(test_end_time[0] + rolling_offset, *test_end_time[1:])} ===========")

            print(f"===========fit_start_time {datetime(train_start_time[0] + rolling_offset, *train_start_time[1:])} ===========")
            print(f"===========fit_end_time {datetime(train_end_time[0] + rolling_offset, *train_end_time[1:])} ===========")
