...
from busi.model_result_test_strategy.strategies.base_rebalance_tuesday_strategy_v2 import BaseRebalanceTuesdayStrategyV2
from busi.model_result_test_strategy.utils.backtest_util import cerebro_show
from busi.model_result_test_strategy.strategies.base_rebalance_tuesday_strategy import BaseRebalanceTuesdayStrategy
...
def run():
    ...
    # 添加策略及其参数
    cerebro.addstrategy(BaseRebalanceTuesdayStrategy)
    # cerebro.addstrategy(BaseRebalanceTuesdayStrategyV2)
    ...
    cerebro_show(cerebro, 'base_strategy')
