...
from models.moment.forecast.data import MomentDataCollator, MomentDataset
...
def main():
    ...
    # 初始化数据集
    train_dataset, eval_dataset = MomentDataset.get_data_sets(data_args, seq_len=model_args.seq_len, forecast_horizon=model_args.forecast_horizon)
