...
from busi.model_result_test_strategy.strategies.csi_small_rebalance_tuesday_strategy import \
    CsiSmallRebalanceTuesdayStrategy
...
def run():
    ...
    csi_class_model_result_path = []

    extend_datas = {
        300: (csi_rank_model_result_path, []),
        100: (rank_model_result_path, [])
    }
    ...
    # 添加策略及其参数
    cerebro.addstrategy(CsiSmallRebalanceTuesdayStrategy)
