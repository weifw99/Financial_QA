...
if __name__ == '__main__':
    ...
    csv_dir_base = '/Users/dabai/liepin/study/llm/Financial_QA/src/busi/bond_/data'
    qlib_csv_dir = csv_dir_base + '/bond_trading/'
    qlib_data_dir = out_base_path + '/cn_data_bond'
    ...
    qlib_csv_dir = csv_dir_base + '/stock_trading/'
    qlib_data_dir = out_base_path + '/cn_data_bond_stock'
